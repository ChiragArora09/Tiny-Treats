  ...
  return (
    <div className="mt-10 bg-[#1a181e] border shadow-xl p-10 rounded-md">
        <div className="flex flex-col gap-8 justify-between my-8 lg:flex-row">
            <AboutItem imgsrc={'/delivery.svg'} heading={"Faster delivery"} subheading={"Delivery within 30-60 minutes (₹35 per order)"} />
            <AboutItem imgsrc={'/payment.svg'} heading={"Payment options"} subheading={"Cash on delivery"} />
            <AboutItem imgsrc={'/support.svg'} heading={"Customer Support"} subheading={"tsamarth.sam@gmail.com"} />
        </div>
        <div className="my-7 flex flex-col gap-2 items-center border-y border-gray-600 py-8">
            ...
            <p className="text-sm text-gray-300 font-thin">Ganj Basoda, Madhya Pradesh 464221, India</p>
        </div>
